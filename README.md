...
Установщик задаст вопросы о названии проекта/VLESS tag, домене/IP и режиме, если они не переданы через переменные окружения или аргументы. Он установит Docker, UFW и `vnstat`, включит сервис `vnstat`, откроет SSH, порт выбранного режима и порт панели 3x-ui, склонирует проект, создаст конфиг и запустит контейнеры.
